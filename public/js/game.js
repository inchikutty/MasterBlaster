var game = new Phaser.Game(800, 600, Phaser.AUTO, '', { preload: preload, create: create, update: update }, 'gameDiv');
...
function update() {
    ...
    game.physics.arcade.overlap(player, letters, collectStar, null, this);
...
function collectStar (player, letter) {
